...
public class UserController {
	...
	public String EditCustomer(HttpServletRequest httpServletRequest,Model model,final @PathVariable(PARAM_ID) long id,@Validated UserBean params,RedirectAttributes redirectAttrs){
	...
	public String AddNew(HttpServletRequest httpServletRequest,Model model,final @Validated UserBean params,RedirectAttributes redirectAttrs)throws Exception{
	...
	public String LoginSubmit(HttpServletRequest httpServletRequest,Model model,final @Validated UserBean params,RedirectAttributes redirectAttrs)throws Exception{
	...
	public String SendEmailLogin(HttpServletRequest httpServletRequest,Model model,RedirectAttributes redirectAttrs,final @Validated UserBean params){
